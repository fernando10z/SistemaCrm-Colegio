...
<script>
  $(document).ready(function() {
        ...
        // Función para exportar boletines a PDF
        window.exportarInteraccionesPDF = function() {
            var tabla = $('#boletines-table').DataTable();
            var datosVisibles = [];
            ...
            form.method = 'POST';
            form.action = 'reports/generar_pdf_boletines_informativos.php';
            form.target = '_blank';
            
            var input = document.createElement('input');
            input.type = 'hidden';
            input.name = 'datosBoletines';
