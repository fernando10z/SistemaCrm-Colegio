                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="Paginación del historial">
                            <ul class="pagination pagination-sm justify-content-end mb-0" id="historial-pagination"></ul>
                        </nav>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
        ...
        if (pagination.total_paginas > 1) {
            ...
            if (pagination.pagina_actual > 1) {
                html += `<li class="page-item">
                    <a class="page-link" href="javascript:void(0)" onclick="cargarDatosHistorial(${pagination.pagina_actual - 1})">Anterior</a>
                </li>`;
            }
            ...
            for (let i = Math.max(1, pagination.pagina_actual - 2); 
                ...
                html += `<li class="page-item ${active}">
                    <a class="page-link" href="javascript:void(0)" onclick="cargarDatosHistorial(${i})">${i}</a>
                </li>`;
            }
            ...
            if (pagination.pagina_actual < pagination.total_paginas) {
                html += `<li class="page-item">
                    <a class="page-link" href="javascript:void(0)" onclick="cargarDatosHistorial(${pagination.pagina_actual + 1})">Siguiente</a>
                </li>`;
            }
        }
    ...
    window.verDetallesCambio = function(cambioId) {
        Swal.fire({
            title: 'Detalles del Cambio',
            text: 'Función en desarrollo - Cambio ID: ' + cambioId,
            icon: 'info'
        });
    };
    
    // Hacer funciones accesibles globalmente
    window.cargarDatosHistorial = cargarDatosHistorial;
});
</script>