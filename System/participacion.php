...
<html lang="es">
  ...
  <body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <script>
      ...
      // Función para exportar estadísticas de participación a PDF
      window.exportarInteraccionesPDF = function() {
          var tabla = $('#participaciones-table').DataTable();
          var datosVisibles = [];
          ...
          form.method = 'POST';
          form.action = 'reports/generar_pdf_estadisticas_participacion.php';
          form.target = '_blank';
          
          var input = document.createElement('input');
          input.type = 'hidden';
          input.name = 'datosParticipacion';
