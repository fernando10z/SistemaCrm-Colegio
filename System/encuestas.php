  ...
  <body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <script>
      $(document).ready(function() {
        ...
        // Función para exportar encuestas a PDF
        window.exportarInteraccionesPDF = function() {
            var tabla = $('#encuestas-table').DataTable();
            var datosVisibles = [];
            ...
            var form = document.createElement('form');
            form.method = 'POST';
            form.action = 'reports/generar_pdf_encuestas_satisfaccion.php';
            form.target = '_blank';
            
            var input = document.createElement('input');
            input.type = 'hidden';
            input.name = 'datosEncuestas';
